...
3. Verdicts are PASS/FAIL/BLK/NA; unfinished BLK rows separately say NOT_RUN or PARTIAL, so queued work cannot be mistaken for a product failure. NA needs an explicit reason. Current ledger after the reviewed Hide & Seek notice repair: 9,261 PASS / 16 FAIL / 3,769 BLK / 3,454 NA; row verdicts are 100 PASS / 16 FAIL / 544 BLK, with 100 COMPLETE / 560 PARTIAL / 0 NOT_RUN. The full audit is still incomplete.
