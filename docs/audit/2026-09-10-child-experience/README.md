...
3. Verdicts are PASS/FAIL/BLK/NA; unfinished BLK rows separately say NOT_RUN or PARTIAL, so queued work cannot be mistaken for a product failure. NA needs an explicit reason. Current ledger after the Tap-a-Tune target repair: 9,437 PASS / 16 FAIL / 3,513 BLK / 3,534 NA; row verdicts are 140 PASS / 16 FAIL / 504 BLK, with 140 COMPLETE / 520 PARTIAL / 0 NOT_RUN. The full audit is still incomplete.
