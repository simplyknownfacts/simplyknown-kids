...
3. Verdicts are PASS/FAIL/BLK/NA; unfinished BLK rows separately say NOT_RUN or PARTIAL, so queued work cannot be mistaken for a product failure. NA needs an explicit reason. Current ledger after the Magic Touch repair: 9,341 PASS / 16 FAIL / 3,649 BLK / 3,494 NA; row verdicts are 120 PASS / 16 FAIL / 524 BLK, with 120 COMPLETE / 540 PARTIAL / 0 NOT_RUN. The full audit is still incomplete.
